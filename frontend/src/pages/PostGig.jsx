          ...
          <form method="post" encType="multipart/form-data" onSubmit={postGig}>
            ...
            {currentStep === 3 && (
              <div className="w-full flex items-center justify-center flex-col p-4 sm:p-6 md:p-8 bg-white rounded-xl ">
                ...
                <label
                  htmlFor="thumbnail"
                  className="max-w-[340px] min-h-[191px] min-w-[340px] max-h-[191px] md:max-h-[430px] md:min-h-[430px] md:min-w-[712px] md:max-w-[712px] overflow-hidden relative cursor-pointer"
                >
